...
public class School extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences1 = getSharedPreferences("Buttons1" + username, Context.MODE_PRIVATE);
        if(sharedPreferences1.getBoolean("Green", false)){
            btn1.setTextColor(ContextCompat.getColor(School.this, R.color.green));
        }
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn1.setTextColor(ContextCompat.getColor(School.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttons1" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();

                btn1.setEnabled(false);
                sharedPreferences.edit().putBoolean("Enabled", false).apply();

                Toast.makeText(School.this, "Добавлено", Toast.LENGTH_SHORT).show();
            }
        });
        btn1p = (Button) view1.findViewById(R.id.progress);
        SharedPreferences sharedPreferences1p = getSharedPreferences("Buttons1p" + username, Context.MODE_PRIVATE);
        if(sharedPreferences1p.getBoolean("Green", false)){
            btn1p.setTextColor(ContextCompat.getColor(School.this, R.color.green));
        }
        ...
        btn1p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn1p.setTextColor(ContextCompat.getColor(School.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttons1p" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();

                btn1p.setEnabled(false);
                sharedPreferences.edit().putBoolean("Enabled", false).apply();

                Toast.makeText(School.this, "Усвоено", Toast.LENGTH_SHORT).show();
            }
        });

        View view2 = findViewById(R.id.btn2);
        btn2 = (Button) view2.findViewById(R.id.save);
        SharedPreferences sharedPreferences2 = getSharedPreferences("Buttons2" + username, Context.MODE_PRIVATE);
        if(sharedPreferences2.getBoolean("Green", false)){
            btn2.setTextColor(ContextCompat.getColor(School.this, R.color.green));
        }
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn2.setTextColor(ContextCompat.getColor(School.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttons2" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences2p = getSharedPreferences("Buttons2p" + username, Context.MODE_PRIVATE);
        if(sharedPreferences2p.getBoolean("Green", false)){
            btn2p.setTextColor(ContextCompat.getColor(School.this, R.color.green));
        }
        ...
        btn2p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn2p.setTextColor(ContextCompat.getColor(School.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttons2p" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences3 = getSharedPreferences("Buttons3" + username, Context.MODE_PRIVATE);
        if(sharedPreferences3.getBoolean("Green", false)){
            btn3.setTextColor(ContextCompat.getColor(School.this, R.color.green));
        }
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn3.setTextColor(ContextCompat.getColor(School.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttons3" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences3p = getSharedPreferences("Buttons3p" + username, Context.MODE_PRIVATE);
        if(sharedPreferences3p.getBoolean("Green", false)){
            btn3p.setTextColor(ContextCompat.getColor(School.this, R.color.green));
        }
        ...
        btn3p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn3p.setTextColor(ContextCompat.getColor(School.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttons3p" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences4 = getSharedPreferences("Buttons4" + username, Context.MODE_PRIVATE);
        if(sharedPreferences4.getBoolean("Green", false)){
            btn4.setTextColor(ContextCompat.getColor(School.this, R.color.green));
        }
        ...
        btn4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn4.setTextColor(ContextCompat.getColor(School.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttons4" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences4p = getSharedPreferences("Buttons4p" + username, Context.MODE_PRIVATE);
        if(sharedPreferences4p.getBoolean("Green", false)){
            btn4p.setTextColor(ContextCompat.getColor(School.this, R.color.green));
        }
        ...
        btn4p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn4p.setTextColor(ContextCompat.getColor(School.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttons4p" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences5 = getSharedPreferences("Buttons5" + username, Context.MODE_PRIVATE);
        if(sharedPreferences5.getBoolean("Green", false)){
            btn5.setTextColor(ContextCompat.getColor(School.this, R.color.green));
        }
        ...
        btn5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn5.setTextColor(ContextCompat.getColor(School.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttons5" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences5p = getSharedPreferences("Buttons5p" + username, Context.MODE_PRIVATE);
        if(sharedPreferences5p.getBoolean("Green", false)){
            btn5p.setTextColor(ContextCompat.getColor(School.this, R.color.green));
        }
        ...
        btn5p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn5p.setTextColor(ContextCompat.getColor(School.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttons5p" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences6 = getSharedPreferences("Buttons6" + username, Context.MODE_PRIVATE);
        if(sharedPreferences6.getBoolean("Green", false)){
            btn6.setTextColor(ContextCompat.getColor(School.this, R.color.green));
        }
        ...
        btn6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn6.setTextColor(ContextCompat.getColor(School.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttons6" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences6p = getSharedPreferences("Buttons6p" + username, Context.MODE_PRIVATE);
        if(sharedPreferences6p.getBoolean("Green", false)){
            btn6p.setTextColor(ContextCompat.getColor(School.this, R.color.green));
        }
        ...
        btn6p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn6p.setTextColor(ContextCompat.getColor(School.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttons6p" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences7 = getSharedPreferences("Buttons7" + username, Context.MODE_PRIVATE);
        if(sharedPreferences7.getBoolean("Green", false)){
            btn7.setTextColor(ContextCompat.getColor(School.this, R.color.green));
        }
        ...
        btn7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn7.setTextColor(ContextCompat.getColor(School.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttons7" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences7p = getSharedPreferences("Buttons7p" + username, Context.MODE_PRIVATE);
        if(sharedPreferences7p.getBoolean("Green", false)){
            btn7p.setTextColor(ContextCompat.getColor(School.this, R.color.green));
        }
        ...
        btn7p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn7p.setTextColor(ContextCompat.getColor(School.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttons7p" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences8 = getSharedPreferences("Buttons8" + username, Context.MODE_PRIVATE);
        if(sharedPreferences8.getBoolean("Green", false)){
            btn8.setTextColor(ContextCompat.getColor(School.this, R.color.green));
        }
        ...
        btn8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn8.setTextColor(ContextCompat.getColor(School.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttons8" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences8p = getSharedPreferences("Buttons8p" + username, Context.MODE_PRIVATE);
        if(sharedPreferences8p.getBoolean("Green", false)){
            btn8p.setTextColor(ContextCompat.getColor(School.this, R.color.green));
        }
        ...
        btn8p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn8p.setTextColor(ContextCompat.getColor(School.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttons8p" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences9 = getSharedPreferences("Buttons9" + username, Context.MODE_PRIVATE);
        if(sharedPreferences9.getBoolean("Green", false)){
            btn9.setTextColor(ContextCompat.getColor(School.this, R.color.green));
        }
        ...
        btn9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn9.setTextColor(ContextCompat.getColor(School.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttons9" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences9p = getSharedPreferences("Buttons9p" + username, Context.MODE_PRIVATE);
        if(sharedPreferences9p.getBoolean("Green", false)){
            btn9p.setTextColor(ContextCompat.getColor(School.this, R.color.green));
        }
        ...
        btn9p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn9p.setTextColor(ContextCompat.getColor(School.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttons9p" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences10 = getSharedPreferences("Buttons10" + username, Context.MODE_PRIVATE);
        if(sharedPreferences10.getBoolean("Green", false)){
            btn10.setTextColor(ContextCompat.getColor(School.this, R.color.green));
        }
        ...
        btn10.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn10.setTextColor(ContextCompat.getColor(School.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttons10" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences10p = getSharedPreferences("Buttons10p" + username, Context.MODE_PRIVATE);
        if(sharedPreferences10p.getBoolean("Green", false)){
            btn10p.setTextColor(ContextCompat.getColor(School.this, R.color.green));
        }
        ...
        btn10p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn10p.setTextColor(ContextCompat.getColor(School.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttons10p" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
            ...
            public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
                switch (item.getItemId()) {
                    case DEFINITION:
                        ...
                        new getTranslation(input, School.this).execute(null, null, null);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch(item.getItemId()){
            case R.id.miProfile:
                Intent profile = new Intent(School.this, UserAccount.class);
                School.this.startActivity(profile);
                return true;
            case R.id.miSettings:
                Intent settings = new Intent(School.this, SettingsActivity.class);
                School.this.startActivity(settings);
                return true;
            default:
