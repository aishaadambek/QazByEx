...
public class Doctors extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getSharedPreferences("INSTR", Context.MODE_PRIVATE).getBoolean("shown", false)){
            ...
            dialog = new Dialog(Doctors.this);
        ...
        SharedPreferences sharedPreferences1 = getSharedPreferences("Buttond1" + username, Context.MODE_PRIVATE);
        ...
        SharedPreferences sharedPreferences2 = getSharedPreferences("Buttond2" + username, Context.MODE_PRIVATE);
        ...
        SharedPreferences sharedPreferences3 = getSharedPreferences("Buttond3" + username, Context.MODE_PRIVATE);
        ...
        SharedPreferences sharedPreferences3p = getSharedPreferences("Buttond3p" + username, Context.MODE_PRIVATE);
            ...
            public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
                switch (item.getItemId()) {
                    case DEFINITION:
                        ...
                        new getTranslation(input, Doctors.this).execute(null, null, null);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch(item.getItemId()){
            case R.id.miProfile:
                Intent profile = new Intent(Doctors.this, UserAccount.class);
                Doctors.this.startActivity(profile);
                return true;
            case R.id.miSettings:
                Intent settings = new Intent(Doctors.this, SettingsActivity.class);
                Doctors.this.startActivity(settings);
                return true;
            default:
