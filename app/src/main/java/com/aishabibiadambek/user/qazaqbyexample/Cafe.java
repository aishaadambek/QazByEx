...
public class Cafe extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences1 = getSharedPreferences("Buttonc1" + username, Context.MODE_PRIVATE);
        ...
        SharedPreferences sharedPreferences7 = getSharedPreferences("Buttonc7" + username, Context.MODE_PRIVATE);
            ...
            public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
                switch (item.getItemId()) {
                    case DEFINITION:
                        ...
                        new getTranslation(input, Cafe.this).execute(null, null, null);
