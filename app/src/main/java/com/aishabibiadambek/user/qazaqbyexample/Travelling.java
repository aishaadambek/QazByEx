...
public class Travelling extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getSharedPreferences("INSTR", Context.MODE_PRIVATE).getBoolean("shown", false)){
            ...
            dialog = new Dialog(Travelling.this);
        ...
        SharedPreferences sharedPreferences1 = getSharedPreferences("Buttont1" + username, Context.MODE_PRIVATE);
        if(sharedPreferences1.getBoolean("Green", false)){
            btn1.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
        }
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn1.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttont1" + username, Context.MODE_PRIVATE);
        ...
        SharedPreferences sharedPreferences1p = getSharedPreferences("Buttont1p" + username, Context.MODE_PRIVATE);
        if(sharedPreferences1p.getBoolean("Green", false)){
            btn1p.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
        }
        ...
        btn1p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn1p.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttont1p" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences2 = getSharedPreferences("Buttont2" + username, Context.MODE_PRIVATE);
        if(sharedPreferences2.getBoolean("Green", false)){
            btn2.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
        }
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn2.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttont2" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences2p = getSharedPreferences("Buttont2p" + username, Context.MODE_PRIVATE);
        if(sharedPreferences2p.getBoolean("Green", false)){
            btn2p.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
        }
        ...
        btn2p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn2p.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttont2p" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences3 = getSharedPreferences("Buttont3" + username, Context.MODE_PRIVATE);
        if(sharedPreferences3.getBoolean("Green", false)){
            btn3.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
        }
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn3.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttont3" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences3p = getSharedPreferences("Buttont3p" + username, Context.MODE_PRIVATE);
        if(sharedPreferences3p.getBoolean("Green", false)){
            btn3p.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
        }
        ...
        btn3p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn3p.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttont3p" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences4 = getSharedPreferences("Buttont4" + username, Context.MODE_PRIVATE);
        if(sharedPreferences4.getBoolean("Green", false)){
            btn4.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
        }
        ...
        btn4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn4.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttont4" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences4p = getSharedPreferences("Buttont4p" + username, Context.MODE_PRIVATE);
        if(sharedPreferences4p.getBoolean("Green", false)){
            btn4p.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
        }
        ...
        btn4p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn4p.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttont4p" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences5 = getSharedPreferences("Buttont5" + username, Context.MODE_PRIVATE);
        if(sharedPreferences5.getBoolean("Green", false)){
            btn5.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
        }
        ...
        btn5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn5.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttont5" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences5p = getSharedPreferences("Buttont5p" + username, Context.MODE_PRIVATE);
        if(sharedPreferences5p.getBoolean("Green", false)){
            btn5p.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
        }
        ...
        btn5p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn5p.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttont5p" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences6 = getSharedPreferences("Buttont6" + username, Context.MODE_PRIVATE);
        if(sharedPreferences6.getBoolean("Green", false)){
            btn6.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
        }
        ...
        btn6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn6.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttont6" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences6p = getSharedPreferences("Buttont6p" + username, Context.MODE_PRIVATE);
        if(sharedPreferences6p.getBoolean("Green", false)){
            btn6p.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
        }
        ...
        btn6p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn6p.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttont6p" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences7 = getSharedPreferences("Buttont7" + username, Context.MODE_PRIVATE);
        if(sharedPreferences7.getBoolean("Green", false)){
            btn7.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
        }
        ...
        btn7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn7.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttont7" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences7p = getSharedPreferences("Buttont7p" + username, Context.MODE_PRIVATE);
        if(sharedPreferences7p.getBoolean("Green", false)){
            btn7p.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
        }
        ...
        btn7p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn7p.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttont7p" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences8 = getSharedPreferences("Buttont8" + username, Context.MODE_PRIVATE);
        if(sharedPreferences8.getBoolean("Green", false)){
            btn8.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
        }
        ...
        btn8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn8.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttont8" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences8p = getSharedPreferences("Buttont8p" + username, Context.MODE_PRIVATE);
        if(sharedPreferences8p.getBoolean("Green", false)){
            btn8p.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
        }
        ...
        btn8p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn8p.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttont8p" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences9 = getSharedPreferences("Buttont9" + username, Context.MODE_PRIVATE);
        if(sharedPreferences9.getBoolean("Green", false)){
            btn9.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
        }
        ...
        btn9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn9.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttont9" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences9p = getSharedPreferences("Buttont9p" + username, Context.MODE_PRIVATE);
        if(sharedPreferences9p.getBoolean("Green", false)){
            btn9p.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
        }
        ...
        btn9p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn9p.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttont9p" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences10 = getSharedPreferences("Buttont10" + username, Context.MODE_PRIVATE);
        if(sharedPreferences10.getBoolean("Green", false)){
            btn10.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
        }
        ...
        btn10.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn10.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttont10" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences10p = getSharedPreferences("Buttont10p" + username, Context.MODE_PRIVATE);
        if(sharedPreferences10p.getBoolean("Green", false)){
            btn10p.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
        }
        ...
        btn10p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn10p.setTextColor(ContextCompat.getColor(Travelling.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttont10p" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
