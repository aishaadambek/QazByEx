...
public class City extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences1p = getSharedPreferences("Button1p" + username, Context.MODE_PRIVATE);
        ...
        SharedPreferences sharedPreferences3 = getSharedPreferences("Button3" + username, Context.MODE_PRIVATE);
        ...
        btn10.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn10.setTextColor(ContextCompat.getColor(City.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Button10" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences10p = getSharedPreferences("Button10p" + username, Context.MODE_PRIVATE);
            ...
            public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
                switch (item.getItemId()) {
                    case DEFINITION:
                        ...
                        new getTranslation(input, City.this).execute(null, null, null);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.miProfile:
                Intent profile = new Intent(City.this, UserAccount.class);
                City.this.startActivity(profile);
                return true;
            case R.id.miSettings:
                Intent settings = new Intent(City.this, SettingsActivity.class);
                City.this.startActivity(settings);
                return true;
            default:
