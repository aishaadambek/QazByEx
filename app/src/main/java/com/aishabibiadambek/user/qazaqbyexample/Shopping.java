...
public class Shopping extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getSharedPreferences("INSTR", Context.MODE_PRIVATE).getBoolean("shown", false)){
            ...
            dialog = new Dialog(Shopping.this);
        ...
        SharedPreferences sharedPreferences1 = getSharedPreferences("Buttonsh1" + username, Context.MODE_PRIVATE);
        if(sharedPreferences1.getBoolean("Green", false)){
            btn1.setTextColor(ContextCompat.getColor(Shopping.this, R.color.green));
        }
        ...
        SharedPreferences sharedPreferences1p = getSharedPreferences("Buttonsh1p" + username, Context.MODE_PRIVATE);
        ...
        SharedPreferences sharedPreferences2 = getSharedPreferences("Buttonsh2" + username, Context.MODE_PRIVATE);
        if(sharedPreferences2.getBoolean("Green", false)){
            btn2.setTextColor(ContextCompat.getColor(Shopping.this, R.color.green));
        }
        ...
        SharedPreferences sharedPreferences2p = getSharedPreferences("Buttonsh2p" + username, Context.MODE_PRIVATE);
        ...
        SharedPreferences sharedPreferences3 = getSharedPreferences("Buttonsh3" + username, Context.MODE_PRIVATE);
        if(sharedPreferences3.getBoolean("Green", false)){
            btn3.setTextColor(ContextCompat.getColor(Shopping.this, R.color.green));
        }
        ...
        SharedPreferences sharedPreferences3p = getSharedPreferences("Buttonsh3p" + username, Context.MODE_PRIVATE);
        ...
        SharedPreferences sharedPreferences4 = getSharedPreferences("Buttonsh4" + username, Context.MODE_PRIVATE);
        if(sharedPreferences4.getBoolean("Green", false)){
            btn4.setTextColor(ContextCompat.getColor(Shopping.this, R.color.green));
        }
        ...
        SharedPreferences sharedPreferences4p = getSharedPreferences("Buttonsh4p" + username, Context.MODE_PRIVATE);
        ...
        SharedPreferences sharedPreferences5 = getSharedPreferences("Buttonsh5" + username, Context.MODE_PRIVATE);
        if(sharedPreferences5.getBoolean("Green", false)){
            btn5.setTextColor(ContextCompat.getColor(Shopping.this, R.color.green));
        }
        ...
        SharedPreferences sharedPreferences5p = getSharedPreferences("Buttonsh5p" + username, Context.MODE_PRIVATE);
        ...
        SharedPreferences sharedPreferences6 = getSharedPreferences("Buttonsh6" + username, Context.MODE_PRIVATE);
        ...
        SharedPreferences sharedPreferences6p = getSharedPreferences("Buttonsh6p" + username, Context.MODE_PRIVATE);
        if(sharedPreferences6p.getBoolean("Green", false)){
            btn6p.setTextColor(ContextCompat.getColor(Shopping.this, R.color.green));
        }
        btn6p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn6p.setTextColor(ContextCompat.getColor(Shopping.this, R.color.green));
                SharedPreferences sharedPreferences = getSharedPreferences("Buttonsh6p" + username, Context.MODE_PRIVATE);
                sharedPreferences.edit().putBoolean("Green", true).apply();
        ...
        SharedPreferences sharedPreferences7 = getSharedPreferences("Buttonsh7" + username, Context.MODE_PRIVATE);
        if(sharedPreferences7.getBoolean("Green", false)){
            btn7.setTextColor(ContextCompat.getColor(Shopping.this, R.color.green));
        }
        ...
        SharedPreferences sharedPreferences7p = getSharedPreferences("Buttonsh7p" + username, Context.MODE_PRIVATE);
        ...
        SharedPreferences sharedPreferences8 = getSharedPreferences("Buttonsh8" + username, Context.MODE_PRIVATE);
        if(sharedPreferences8.getBoolean("Green", false)){
            btn8.setTextColor(ContextCompat.getColor(Shopping.this, R.color.green));
        }
        ...
        SharedPreferences sharedPreferences8p = getSharedPreferences("Buttonsh8p" + username, Context.MODE_PRIVATE);
        ...
        SharedPreferences sharedPreferences9 = getSharedPreferences("Buttonsh9" + username, Context.MODE_PRIVATE);
        if(sharedPreferences9.getBoolean("Green", false)){
            btn9.setTextColor(ContextCompat.getColor(Shopping.this, R.color.green));
        }
        ...
        SharedPreferences sharedPreferences9p = getSharedPreferences("Buttonsh9p" + username, Context.MODE_PRIVATE);
        ...
        SharedPreferences sharedPreferences10 = getSharedPreferences("Buttonsh10" + username, Context.MODE_PRIVATE);
        if(sharedPreferences10.getBoolean("Green", false)){
            btn10.setTextColor(ContextCompat.getColor(Shopping.this, R.color.green));
        }
        ...
        SharedPreferences sharedPreferences10p = getSharedPreferences("Buttonsh10p" + username, Context.MODE_PRIVATE);
            ...
            public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
                switch (item.getItemId()) {
                    case DEFINITION:
                        ...
                        new getTranslation(input, Shopping.this).execute(null, null, null);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch(item.getItemId()){
            case R.id.miProfile:
                Intent profile = new Intent(Shopping.this, UserAccount.class);
                Shopping.this.startActivity(profile);
                return true;
            case R.id.miSettings:
                Intent settings = new Intent(Shopping.this, SettingsActivity.class);
                Shopping.this.startActivity(settings);
                return true;
            default:
